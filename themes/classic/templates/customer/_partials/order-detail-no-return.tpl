                            ...
                            <div class="product-customization-line row">
                              ...
                              <div class="col-sm-9 col-xs-8 value">
                                ...
                                {elseif $field.type == 'image'}
                                  {if strpos($field.image.small.url, '.pdf') !== false}
                                      <a href="{$field.image.small.url}" href="_blank" title=""><img src="../img/pdf.png" width="40"> {l s='Download' d='Shop.Theme.Global'}</a>
                                    {elseif strpos($field.image.small.url, '.ai') !== false}
                                      <a href="{$field.image.small.url}" href="_blank" title=""><img src="../img/ai.png" width="40"> {l s='Download' d='Shop.Theme.Global'}</a>
                                    {else}
