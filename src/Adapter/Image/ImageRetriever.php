...
class ImageRetriever
{
    ...
    public function getCustomizationImage($imageHash)
    {
        ...
        if (\file_exists(_PS_UPLOAD_DIR_.$imageHash.'.pdf')) {
            $small_image_url = $large_image_url . '.pdf';
            $large_image_url .= '.pdf';
        } elseif (\file_exists(_PS_UPLOAD_DIR_.$imageHash.'.ai')) {
            $small_image_url = $large_image_url . '.ai';
            $large_image_url .= '.ai';
        } else {
